...
export default function CaseStudiesDtailOne() {
    return (
        <>
                ...
                <div className="introduce">
                    <div className="container">
                        ...
                        <div className="desc-block flex items-center justify-center lg:mt-10 mt-7">
                            <p className="desc w-5/6 heading5 font-normal normal-case text-center">8American tech companies continue to propel the nation’s economy forward. Not only has technological innovation become an integral part of the way we live, it is also important to our nation’s economic success.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="flex max-lg:flex-col items-center justify-between gap-y-10">
                            <div className="lg:w-1/2 lg:pr-10">
                                <div className="bg-img w-full">
                                    <img className="w-full rounded-3xl" src="/images/blog/1290x837.png" alt="blog/item4.png" />
                                </div>
                            </div>
                ...
                <section className="benefit lg:pt-20 sm:pt-14 pt-10">
                    <div className="container">
                        <div className="heading flex max-lg:flex-col justify-between gap-y-4">
                            ...
                            <div className="xl:w-5/12 lg:w-6/12">
                                <div className="body2 text-surface1 lg:text-end">At Abnoq, we understand that selecting the right partner for your technology needs is a critical decision. We believe that we are the perfect fit for you, and here's why.</div>
                            </div>
                        </div>
